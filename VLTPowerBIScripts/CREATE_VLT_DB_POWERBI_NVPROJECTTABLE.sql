...
AS
	SELECT NvProjectTable.PROJECTID,
		   ...
		   (
			   ...
			   JOIN SALESTABLE ON (SALESTABLE.SALESID = CUSTINVOICEJOURPART_ADDON.SALESID AND SALESTABLE.NVPROJECTID = NvProjectTable.PROJECTID AND SALESTABLE.MAINSALESORDER_ADDON = 1)
