...
AS
	SELECT
		...
		CUSTQUOTATIONSALESLINK.SALESID + CUSTQUOTATIONSALESLINK.QUOTATIONID + CUSTQUOTATIONSALESLINK.QUOTATIONDATE + CUSTQUOTATIONSALESLINK.DATAAREAID AS FKCustQuotationJour, 
		CUSTQUOTATIONSALESLINK.ORIGSALESID + CUSTQUOTATIONSALESLINK.QUOTATIONID + CUSTQUOTATIONSALESLINK.QUOTATIONDATE + CUSTQUOTATIONSALESLINK.DATAAREAID AS PKCustQuotationJour, 
